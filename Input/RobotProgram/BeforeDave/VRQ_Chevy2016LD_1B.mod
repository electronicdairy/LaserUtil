MODULE VRQ_Chevy2016LD_1B
	...
	PROC rT1B_VRQ_Welding_Chevy2016LD()
		...
		!	
            ...
            IF ToolBSub2PP = 1 THEN
            !
            rSetLaser_PFO_Prog_Num 131, 879;
